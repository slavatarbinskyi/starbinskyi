...
namespace IO.Swagger.Model
{
    ...
    public partial class RegisterExternalBindingModel :  IEquatable<RegisterExternalBindingModel>
    {
        ...
        protected RegisterExternalBindingModel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RegisterExternalBindingModel" /> class.
        /// </summary>
        /// <param name="Email">Email (required).</param>
        public RegisterExternalBindingModel(string Email = null)
        {
            // to ensure "Email" is required (not null)
            if (Email == null)
            {
                throw new InvalidDataException("Email is a required property for RegisterExternalBindingModel and cannot be null");
            }
            else
            {
                this.Email = Email;

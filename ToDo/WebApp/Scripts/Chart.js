						...
						Chart.controllers.bubble = Chart.DatasetController.extend({
								...
								helpers.extend(point,
								{
									...
									_model: {
										x: reset
											...
											: xScale.getPixelForValue(typeof data === "object" ? data : NaN, index, dsIndex, me.chart.isCombo),
							...
							setHoverStyle: function(point) {
								...
								model.radius = custom.hoverRadius
									? custom.hoverRadius
									: (helpers.getValueAtIndexOrDefault(dataset.hoverRadius, index, me.chart.options.elements.point.hoverRadius)) +
							...
							updateElement: function(arc, index, reset) {
								...
								var chart = me.chart,
									...
									circumference = reset && animationOpts.animateRotate
										? 0
										: arc.hidden ? 0 : me.calculateCircumference(dataset.data[index]) * (opts.circumference / (2.0 * Math.PI)),
								...
								if (showLine) {
									...
									line._model = {
										...
										cubicInterpolationMode: custom.cubicInterpolationMode
											...
											: helpers.getValueOrDefault(dataset.cubicInterpolationMode, lineElementOptions.cubicInterpolationMode),
										// Scale
										scaleTop: scale.top,
					...
					module.exports = function(Chart) {
						...
						Chart.controllers.polarArea = Chart.DatasetController.extend({
							...
							update: function(reset) {
								...
								chart.innerRadius = Math.max(opts
									.cutoutPercentage
...
// value not used in dataset scale, but we want a consistent API between scales
										...
										backgroundColor: custom.backgroundColor
											? custom.backgroundColor
											: helpers.getValueAtIndexOrDefault(dataset.pointBackgroundColor, index, pointElementOptions.backgroundColor),
										borderColor: custom.borderColor
											? custom.borderColor
							...
							draw: function(chartArea) {
								...
								if (isHorizontal) {
									...
									if ((longestRotatedLabel + optionTicks.autoSkipPadding) * me.ticks.length >
										...
										skipRatio = 1 +
											Math.floor(((longestRotatedLabel + optionTicks.autoSkipPadding) * me.ticks.length) /
												(me.width - (me.paddingLeft + me.paddingRight)));
									}
								...
								helpers.each(me.ticks,
									function(label, index) {
										...
										if (isHorizontal) {
											...
											labelX = me
												.getPixelForTick(index, gridLines.offsetGridLines) +
						...
						var TimeScale = Chart.Scale.extend({
							...
							determineDataLimits: function() {
								...
								if (me.chart.data.labels && me.chart.data.labels.length > 0) {
									helpers.each(me.chart.data.labels,
										function(label) {
							...
							buildTicks: function() {
								...
								var tickFontStyle = helpers.getValueOrDefault(me.options.ticks
									.fontStyle,
								...
								if (me.options.time.unit) {
									...
									while (unitDefinitionIndex < time.units.length) {
										...
										if (helpers.isArray(unitDefinition.steps) &&
											...
											me.unitScale = helpers.getValueOrDefault(me.options.time.unitStepSize,
											...
											var trailingUnitBuffer = me.getMomentStartOf(me.lastTick.clone().add(1, me.tickUnit))
							...
							parseTime: function(label) {
								...
								if (typeof me.options.time.format !== "string" && me.options.time.format.call) {
									console
										.warn("options.time.format is deprecated and replaced by options.time.parser. See http://nnnick.github.io/Chart.js/docs-v2/#scales-time-scale");
